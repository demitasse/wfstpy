...
if __name__ == "__main__":
    ...
    #add arcs
    wfst.st[states[0]].ar.append(Arc(il=1, ol=1, wt=TropicalWeight(3.0), nst=states[1]))
    wfst.st[states[0]].ar.append(Arc(il=4, ol=4, wt=TropicalWeight(5.0), nst=states[2]))
    wfst.st[states[1]].ar.append(Arc(il=2, ol=2, wt=TropicalWeight(2.0), nst=states[1]))
    wfst.st[states[1]].ar.append(Arc(il=3, ol=3, wt=TropicalWeight(4.0), nst=states[3]))
    wfst.st[states[2]].ar.append(Arc(il=5, ol=5, wt=TropicalWeight(4.0), nst=states[3]))
    #set starting state
